...
keys=" ${ID:-} ${ID_LIKE:-} "
manager=""
common_deb=(build-essential cmake pkg-config portaudio19-dev libasound2-dev libgtk-3-dev libyaml-cpp-dev libcurl4-openssl-dev libssl-dev nlohmann-json3-dev)
common_rpm=(gcc-c++ make cmake pkgconf-pkg-config portaudio-devel alsa-lib-devel gtk3-devel yaml-cpp-devel libcurl-devel openssl-devel nlohmann-json-devel)
common_arch=(base-devel cmake pkgconf portaudio alsa-lib gtk3 yaml-cpp curl openssl nlohmann-json)
packages=()
